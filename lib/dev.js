...
var getErrorHandling = function getErrorHandling(params) {
  ...
  var defaultDescr = 'unnamed entity';
  ...
  var logError = function logError(params) {
    try {
      ...
      var _descr = typeof params.descr === 'string' ? params.descr : defaultDescr;
      ...
      return {
        userMsg: "Issue with: ".concat(defaultDescr),
  ...
  var getHandledServer = createFunc('initializing error handling for server', function (server) {
    ...
    var sockets = new Set();
    var innerServerListener = createFunc('handling server closing', function (eventOrError) {
